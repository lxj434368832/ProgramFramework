...
namespace zxl
{
    ...
    class base::staticclass
    {
    private:
        staticclass();
        staticclass(const staticclass &);
        staticclass& operator=(const staticclass&);
        staticclass& operator=(staticclass&&);
    };
...
namespace zxl{
    namespace base{
        ...
        namespace utils{
            ...
            class files : public staticclass
            {
            public:
            ...
            class date_time : public staticclass
            {
            public:
